...
// UserStats regroupe les indicateurs du tableau de bord d'un utilisateur.
type UserStats struct {
	...
	TotalGagne        int     `json:"total_gagne"`   // crédits gagnés via échanges
	TotalDepense      int     `json:"total_depense"` // crédits dépensés nets (spend − refund)
}
